...
export const ddo4 = {
  ...ddo,
  id: 'did:nv:0c184915b07b44c888d468be85a9b28253e80070e5294b1aaed81c2f0264e900',
  service: [
    {
      index: 0,
      serviceEndpoint: 'http://localhost:5000/api/v1/metadata/assets/ddo/{did}',
...
export const ddo5 = {
  ...ddo4,
  id: 'did:nv:0c184915b07b44c888d468be85a9b28253e80070e5294b1aaed81c2f0264e950',
  findServiceByType: (type: string) => ddo3.service.find((s) => s.type === type),
}
...
export const nevermined = {
  getInstance: async () => ({
    ...
    search: {
      ...
      datasetsBySubscription: () => ({ results: [ddo4, ddo5] }),
    },
    keeper: {
      conditions: {
